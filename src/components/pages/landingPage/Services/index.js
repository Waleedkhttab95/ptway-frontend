        ...
        >
          ...
          >
            <TabPane tab="يومي" key="1" forceRender={true}>
              تستطيع من خلال هذا الخيار الحصول على موظفين للعمل ليوم واحد أو
              لعدة أيام حسب الطلب، يناسب الشركات المهتمة بتنظيم المعارض
              والمؤتمرات والإحتفالات والتسويق والترويج
              <br />
            ...
            <TabPane tab=" عقود" key="3" forceRender={true}>
              ...
              لشهر أو عدة أشهر تناسب الشركات التي تحصل على عقود مؤقتة مثل
              المشاريع أو تعمل اثناء المواسم الطويله مثل الصيف
              <br />
              <Link to="/user/signup" className="tag-link">
                {'<'} انضم معنا
              </Link>
